...
import com.cls.monitor.mapper.LogMapper;
...
public class LogServiceImpl extends ServiceImpl<LogMapper, SystemLog> implements ILogService {
    ...
    @Override
    public PageInfo<SystemLog> findLogs(SystemLog systemLog, QueryRequest request) {
        ...
        List<SystemLog> list = this.list(queryWrapper);
