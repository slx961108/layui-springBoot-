 ...
 */
@MyEndPoint
public class MyMetricsEndpoint {

    private final MeterRegistry registry;

    public MyMetricsEndpoint(MeterRegistry registry) {
    ...
    @ReadOperation
    public MyMetricResponse metric(@Selector String requiredMetricName, @Nullable List<String> tag) {
        ...
        if (meters.isEmpty()) {
            ...
            return new MyMetricResponse(requiredMetricName, meterId.getDescription(), meterId.getBaseUnit(), this.asList(samples, Sample::new), this.asList(availableTags, AvailableTag::new));
        }
    }
    ...
    public static final class MyMetricResponse {
        ...
        MyMetricResponse(String name, String description, String baseUnit, List<Sample> measurements, List<AvailableTag> availableTags) {
            this.name = name;
